...
public class Kohonen {
  ...
  /*
   * trains the network so algorithm can learn for learning calculates near values
   * for coordinates find closest neuron for these coordinates update weight of
   * the closest neuron updates learningrate
   */
